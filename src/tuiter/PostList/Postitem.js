...
const Postiteml = ( {
    ...
    <div className="row">
          <div className="col-1">
               <img className="float-start rounded-pill wd-width me-2 border border-solid border-white" src={`/images/${post1.image}`}/>
            </div>
                ...
                <div className="d-inline text-secondary"><i className="fa-solid fa-paperclip"></i></div>
                 <div className="d-inline text-secondary">{post1.link}</div>
                   ...
                   <div className="d-flex justify-content-between">
                      <div className="p-2 btn-danger"><FontAwesomeIcon icon={faComment} className="me-2" />{post1.comment}</div>
                      <div className="p-2 bd-highlight"><FontAwesomeIcon icon={faRetweet} className="me-2" />{post1.retweet}</div>
                      <div className="p-2 bd-highlight"><FontAwesomeIcon icon={faHeart} className="me-2" />{post1.like}</div>
                      <div className="p-2 bd-highlight"><FontAwesomeIcon icon={faArrowUpFromBracket} className="me-2" /></div>
                    </div>
           </div>
            </div>
        </div>
